...
public class ZoomImageView extends ImageView implements View.OnTouchListener {
    ...
    public ZoomImageView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        setOnTouchListener(this);
    ...
    public ZoomImageView(@NonNull Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setOnTouchListener(this);
        parseAttributes(context, attrs);
    }

    private void parseAttributes(@NonNull Context context, AttributeSet attrs) {
    ...
    private void checkClick(@NonNull MotionEvent event) {
    ...
    private void moveImage(@NonNull MotionEvent event) {
    ...
    private void scaleImage(@NonNull MotionEvent event) {
